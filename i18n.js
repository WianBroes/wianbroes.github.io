(function () {
  const translations = {
    en: {
      ...
      "inkorb.desc": "A ball rolls across the canvas and leaves a trail of paint behind it, precise or chaotic depending on speed and gesture, obstacles, gravity, gyroscope, drawing and more. Layers, a pigment mixer, several customizable balls, image export. No ads, no accounts, no network connection.",
    ...
    fr: {
      ...
      "inkorb.desc": "Une bille roule sur la toile et laisse une traînée de peinture derrière elle, précise ou chaotique selon la vitesse et le geste, les obstacles, la gravité, le gyroscope, le dessin et plus encore. Calques, mélangeur de pigments, plusieurs billes personnalisables, export en image. Aucune pub, aucun compte, aucune connexion réseau.",
